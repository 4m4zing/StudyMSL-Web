<%@ Page Title="" Language="C#" MasterPageFile="~/Default_User.Master" AutoEventWireup="true" CodeBehind="SentencePage.aspx.cs" Inherits="StudyMSL_W.Learn.SentencePage" %>
	...
	<section id="main" class="wrapper">
		<div class="inner">
			<div class="content">
                ...
                <asp:Button runat="server" id="btnHiddenSentence1" style="display:none" onclick="btncSentence1_OnClicked"/>

                <div class="carousel"
                  data-flickity='{ "freeScroll": false, "contain": false, "prevNextButtons": true, "pageDots": true, "cellAlign": "center"}'>
                    <div class="carousel-cell">
                        <p class="flickityText" >Sentence Builder</p>
                    </div>
                </div>
                ...
                <script type="text/javascript">
                    var btnHidden1 = $('#<%= btnHiddenSentence1.ClientID %>');
