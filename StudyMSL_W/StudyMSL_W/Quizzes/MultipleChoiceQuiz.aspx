<%@ Page Title="" Language="C#" MasterPageFile="~/Default_User.Master" AutoEventWireup="true" CodeBehind="MultipleChoiceQuiz.aspx.cs" Inherits="StudyMSL_W.Quizzes.MultipleChoiceQuiz" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBanner" runat="server">
    <!-- Heading -->
	<div id="heading" >
		<h1>Multiple Choice Quiz - <asp:Label ID="lblQuestionType" runat="server"></asp:Label></h1>
	</div>
</asp:Content>
		...
		<div class="inner" style="clear:initial">
			...
			<div class="customcontent" style="clear:initial" >
                <div class="centered" style="clear:initial" >
                    ...
                    <br /><br />
                    <asp:button ID="btnAnswer1" runat="server" OnClick="btnAnswer1_OnClick" CssClass="centerbutton" ></asp:button>
                    <br />
                    <asp:button ID="btnAnswer2" runat="server" OnClick="btnAnswer2_OnClick" CssClass="centerbutton" ></asp:button>
                    <br />
                    <asp:button ID="btnAnswer3" runat="server" OnClick="btnAnswer3_OnClick" CssClass="centerbutton" ></asp:button>
                    <br />
                    <asp:button ID="btnAnswer4" runat="server" OnClick="btnAnswer4_OnClick" CssClass="centerbutton" ></asp:button>
                </div>
			</div>
		</div>
    </section>
